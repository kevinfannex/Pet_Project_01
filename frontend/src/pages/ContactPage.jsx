    ...
    <div style={{ paddingTop: '0' }}>
      <section className="location-banner fade-up" style={{
        ...
        <div style={{ position: 'relative', zIndex: 1 }}>
          <h3 style={{ color: 'var(--white)', fontSize: '36px', fontFamily: 'var(--font-head)', marginBottom: '16px', textShadow: '0 2px 8px rgba(0,0,0,0.5)' }}>
            📍 Find Us in Bangalore
          </h3>
          <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: '18px', maxWidth: '600px', margin: '0 auto', textShadow: '0 1px 4px rgba(0,0,0,0.5)', lineHeight: '1.6' }}>
      ...
      <section id="contact-form" className="contact-form fade-up" style={{ padding: '80px 7%', background: '#FEF8F0', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))', gap: '60px', alignItems: 'center' }}>
        <div>
          ...
          <h2 style={{ fontFamily: 'var(--font-head)', fontSize: '40px', color: 'var(--navy)', marginBottom: '20px', lineHeight: '1.1' }}>Send us a <span>message</span></h2>
          <p style={{ color: 'var(--gray)', marginBottom: '40px', fontSize: '16px', lineHeight: '1.8' }}>Have a question about our services or need to reschedule an appointment? Send us a quick message and our team will get back to you within 24 hours.</p>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div style={{ padding: '24px', background: 'var(--white)', borderRadius: '20px', border: '1px solid rgba(30,43,58,0.05)' }}>
        ...
        <form style={{ display: 'flex', flexDirection: 'column', gap: '20px', background: 'var(--white)', padding: '40px', borderRadius: '32px', boxShadow: '0 20px 40px rgba(0,0,0,0.04)' }} onSubmit={e => e.preventDefault()}>
